	...
	<div class="content-user-profile" >
		<div class="content-group-profile profile" style='min-height: 310px;'>
			...
			<div class="content-group-profile-avatar">
				...
				<img src="/assets/files/user_logo/<?echo $data['avatar_user'];?>"  date-titleImg="<?echo $data['login_user']?>">
				
			</div>
			<div class="content-group-profile-info">
				<div class="profile-info-name"><? echo $data['surname_user']." ".$data['name_user']." ".$data['patronymic_user']?> <span class='online-user'><?php if ($_SESSION["user"]["access_role"] == "30"): ?>
					<a href="/edit/user/<?echo $data["id_user"] ?>">редактировать</a></span>
				<?php endif ?>
...
<?php if ($data['id_role_user'] == '1'): ?>
	<div class="content-group-profile-info-all profile">
		<div class="row">
			<h2>Информация о пользователе: <?echo $data['login_user']?></h2>
		</div>
		...
		<div class="row clearfix">
			<div class="row-2">
				...
				<div class="row clearfix">
					...
					<div class="row-1"><a href="/groups/id/<?echo $data["id_group"]?>"><?echo $data[0][2]['name_specialty']?></a></div>
				</div>
				<div class="row clearfix">
				...
				<div class="row clearfix">
					<div class="row-3">Рабочая область:</div>
					<div class="row-1"><a href="/my/dashboard/<?echo $data['id_workspace']?>">Рабочая область</a></div>
				</div>
			</div>
			<div class="row-2">
				<div class="row clearfix">
